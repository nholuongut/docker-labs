...
Docker is not quite like a VM. It uses the host kernel & can’t boot a different operating system. Below are 5 similarities between Docker & VIrtual Machine:
 ...
 ![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/Picture1.png)

# How is Docker different from Virtual Machine?
 
Figure: Docker Vs VM
Below are list of 6 difference between Docker container & VM:
![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/docker-interview2.png)
 

# What is the difference between Container Networking & VM Networking?
 ![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/docker-interview-3.png)
...
Example: Here is a Dockerfile using this approach, that assumes the pre-written supervisord.conf, my_first_process, and my_second_process files all exist in the same directory as your Dockerfile.
 ![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/docker-interview-4.png)
...
# What does CNM refers to? What are its components? ![img](
 ![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/docker-interview-5.png)
...
Sandbox is a generic term that refers to OS specific technologies used to isolate networks stacks on a Docker host. Docker on Linux uses kernel namespaces to provide this sandbox functionality. Networks “stacks” inside of sandboxes include interfaces, routing tables, DNS etc. A network in CNM terms is one or more endpoints that can communicate.All endpoints on the same network can communicate with each other.Endpoints on different networks cannot communicate without external routing.
  ![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/docker-interview-6.png)

# What are different types of Docker Networking drivers? 
 ![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/docker-interview-7.png)
...
![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/docker-interview-8.png)
...
![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/docker-interview-9.png)
...
![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/docker-interview-10.png)

 
# How to connect Docker container to user-defined bridge network?

![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/docker-interview-11.png)
...
![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/docker-interview-12.png)
...
![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/docker-interview-13.png)
...
![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/docker-interview-14.png)
...
![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/docker-interview-16.png)
...
![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/docker-interview-17.png)
...
![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/docker-interview-18.png)
...
To understand it clearly, let us consider the below Dockerfile:
 ![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/docker-interview-19.png)

If you try building this Docker image using `docker build command` -

  ![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/docker-interview-21.png)

 Let us run this image without any argument.
  ![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/docker-interview-22.png)

 

Let's run it passing a command line argument
  ![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/docker-interview-23.png)
...
# Difference between Windows Containers and Hyper-V Containers
  ![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/docker-interview-24.png)
...
Differences:
  ![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/docker-interview-25.png)
...
Below are the major list of differences between Docker Swarm & Kubernetes:
 ![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/docker-interview-26.png)
...
The ‘docker stack deploy’ is a command to deploy a new stack or update an existing stack. A stack is a collection of services that make up an application in a specific environment. A stack file is a file in YAML format that defines one or more services, similar to a docker-compose.yml file for Docker Compose but with a few extensions. 
 ![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/docker-interview-27.png)
...
# docker service create --name nginx --publish 80:80 nginx
 ![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/docker-interview-29.png)
...
Docker Engine swarm mode makes it easy to publish ports for services to make them available to resources outside the swarm. All nodes participate in an ingress routing mesh. The routing mesh enables each node in the swarm to accept connections on published ports for any service running in the swarm, even if there’s no task running on the node. The routing mesh routes all incoming requests to published ports on available nodes to an active container.
 ![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/docker-interview-30.png)
...
Starting Docker CE 17.06 release, Docker provides support for local scope networks in Swarm. This includes any local scope network driver. Some examples of these are bridge, host, and macvlan though any local scope network driver, built-in or plug-in, will work with Swarm. Previously only swarm scope networks like overlay were supported. 
 ![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/docker-interview-31.png)
...
In Docker there are three key components to container security and together they result in inherently safer apps.
  ![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/docker-interview-32.png)
...
The following diagram provides a high-level view of how the Docker swarm mode architecture is applied to securely deliver a new type of object to our containers: a secret object.
 ...
 ![img](https://raw.githubusercontent.com/nholuongut/dockerlabs/master/docker/img/docker-interview-33.png)
