...
Go and download the HelloWorld source code by running the commands below:
        ...
        git clone https://github.com/nholuongut/k8s-go-hello-world-demo.git
...
![docker-image](https://raw.githubusercontent.com/nholuongut/k8s-go-hello-world-demo/master/Docker-screenshot.png)
...
```
Biradars-MacBook-Air-4:helloworld sangam$ docker tag helloworld:v1 nholuongut/hello-world:v1
Biradars-MacBook-Air-4:helloworld sangam$ docker push nholuongut/hello-world
The push refers to repository [docker.io/nholuongut/hello-world]
82c8a7f71889: Pushed 
d94c6198e159: Pushed 
e15881a3c920: Pushed 
...
Golang app https://hub.docker.com/r/nholuongut/hello-world. pull the ready container 
...
![dashboard](https://github.com/nholuongut/k8s-go-hello-world-demo/blob/master/dashboard-ui.png)
...
![browser](https://github.com/nholuongut/k8s-go-hello-world-demo/blob/master/browser_go_app.png)

> This uses a local IP address that serves our app and opens up a browser displaying our “Hello World” message.


![service image](https://github.com/nholuongut/k8s-go-hello-world-demo/blob/master/K8s_Diagrams1-4-1.jpg)
...
![service-image-update](https://github.com/nholuongut/k8s-go-hello-world-demo/blob/master/Service_Diagrams1-3.jpg)
