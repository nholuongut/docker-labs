...
```
$ docker run -d --net=net1 --name nettools nholuongutlabs/ubuntu-nettools:v1.0
```
...
```
 $ docker run -d --net=net2 --name net2tool nholuongutlabs/ubuntu-nettools:v1.0 sleepinfinity
...
CONTAINER ID        IMAGE                                COMMAND             CREATED
             STATUS              PORTS               NAMES
e7310afe1c92        nholuongutlabs/ubuntu-nettools:v1.0   "sleep infinity"    2 minut
es ago       Up 2 minutes                            net2tool
98adad911ecc        nholuongutlabs/ubuntu-nettools:v1.0   "sleep infinity"    4 minut
