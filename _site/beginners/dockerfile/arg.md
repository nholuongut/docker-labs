...
## Writing a Dockerfile with ARG instruction
We are writing a Dockerfile which echo "Welcome $WELCOME_USER, to Docker World!" where default argument value for <b>WELCOME_USER</b> as <b>nholuongut</b>.
```
FROM alpine:3.9.3
LABEL maintainer="nholuongut"

#Setting a default value to Argument WELCOME_USER
ARG WELCOME_USER=nholuongut
...
Welcome nholuongut, to Docker World!
```
...
Next >> [Lab #9: ENV instruction](https://dockerlabs.nholuongut.com/beginners/dockerfile/Lab_%239_ENV_instruction.html)
