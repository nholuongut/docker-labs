...
8590497d994e        45 seconds ago      /bin/sh -c #(nop)  LABEL maintainer=nholuongut   0B                  
...
8590497d994e        8 minutes ago       /bin/sh -c #(nop)  LABEL maintainer=nholuongut   0B                  
cdf98d1859c1        4 months ago        /bin/sh -c #(nop)  CMD ["/bin/sh"]              0B                  
<missing>           4 months ago        /bin/sh -c #(nop) ADD file:2e3a37883f56a4a27…   5.53MB
```
Number of layers 4
...
Next » [Lab #8: ARG instruction](https://dockerlabs.nholuongut.com/beginners/dockerfile/arg.html)
