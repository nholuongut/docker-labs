...
```
git clone git@github.com:nholuongut/docker_onbuild.git 
cd docker_onbuild
docker build -t nholuongut/docker_onbuild .
...
Next >> [healthcheck](https://dockerlabs.nholuongut.com/beginners/dockerfile/healthcheck.html)
