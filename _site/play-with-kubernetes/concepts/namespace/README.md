...
```
Ajeets-MacBook-Air:testenviron ajeetraina$ cat nholuongut-namespace.yml 
apiVersion: v1
kind: Namespace
metadata:
  name: nholuongut
...
```
kubectl create -f ./nholuongut-namespace.yml
```
...
NAME          STATUS    AGE
nholuongut     Active    29m
```

## How to build Namespace with CPU Limit

```
Ajeets-MacBook-Air:testenviron ajeetraina$ cat cpu-nholuongut.yml 
apiVersion: v1
kind: LimitRange
metadata:
...
```
Ajeets-MacBook-Air:testenviron ajeetraina$ kubectl create -f ./cpu-nholuongut.yml --namespace=nholuongut
limitrange "cpu-limit-range" created
```
## Creating Pod

```
Ajeets-MacBook-Air:testenviron ajeetraina$ cat cpu-nholuongut-pods.yml 
apiVersion: v1
kind: Pod
metadata:
...
```
Ajeets-MacBook-Air:testenviron ajeetraina$ kubectl create -f ./cpu-nholuongut-pods.yml --namespace=nholuongut
...
```
Ajeets-MacBook-Air:testenviron ajeetraina$ kubectl get pod default-cpu-demo --output=yaml --namespace=nholuongut
apiVersion: v1
kind: Pod
metadata:
  annotations:
  ...
  selfLink: /api/v1/namespaces/nholuongut/pods/default-cpu-demo
...
```
Ajeets-MacBook-Air:testenviron ajeetraina$ kubectl describe namespace nholuongut
Name:         nholuongut
Labels:       <none>
Annotations:  <none>
Status:       Active
