...
```
$ docker tag alpine:3.6 registry.nholuongut.com/alpine:3.6
```

This time you need to provide login credentials to use local repository.

```
$ docker push registry.nholuongut.com/alpine:3.6
...
```
$ docker pull registry.nholuongut.com/alpine:3.6
```

Error response from daemon: Get https://registry.nholuongut.com/v2/alpine/manifests/3.6: no basic auth credentials

## Log in to the local registry.

```
$ docker login --username username registry.nholuongut.com
Password: ********
...
```
The push refers to repository [registry.nholuongut.com/alpine]
e27a10675c56: Pushed
...
```
$ docker image remove registry.nholuongut.com/alpine:3.6

Untagged: registry.nholuongut.com/alpine:3.6
Untagged: registry.sl.nholuongut.com/alpine@sha256:02741df16aee1b81c4aaff4c48d75cc2c308bade918b22679df570c170feef7c
...
Status: Downloaded newer image for registry.nholuongut.com/alpine:3.6
```
...
registry.nholuongut.com/alpine        3.6             da653cee0545        2 months ago        100MB
hello-world                          latest              f2a91732366c        2 months ago     
```

Next >> [Building a Private Docker Registry with UI](https://dockerlabs.nholuongut.com/beginners/portus/)
