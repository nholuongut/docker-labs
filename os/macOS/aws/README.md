...
```
 aws route53 create-hosted-zone --name nholuongut.com --caller-reference 2
 ...
 * edit this cluster with: kops edit cluster k8.aws.dev.nholuongut.com
...
![My image](https://github.com/nholuongut/dockerlabs/blob/master/os/macOS/aws/context-aws.png)
